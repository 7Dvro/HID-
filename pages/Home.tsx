...
const Home: React.FC = () => {
  ...
  const featuredImams = [
      { name: language === 'ar' ? 'الشيخ محمد إبراهيم' : 'Sheikh Mohammed Ibrahim', role: language === 'ar' ? 'إمام وخطيب' : 'Imam & Khatib', image: 'https://images.unsplash.com/photo-1566753323558-f4e0952af115?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80', location: language === 'ar' ? 'الخرطوم' : 'Khartoum' },
      ...
      { name: language === 'ar' ? 'الشيخ عبدالله صالح' : 'Sheikh Abdullah Saleh', role: language === 'ar' ? 'مقرئ' : 'Reciter', image: 'https://images.unsplash.com/photo-1628718683647-062e74284d72?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80', location: language === 'ar' ? 'بحري' : 'Bahri' },
      { name: language === 'ar' ? 'الشيخ عمر أحمد' : 'Sheikh Omar Ahmed', role: language === 'ar' ? 'داعية' : 'Da\'i', image: 'https://images.unsplash.com/photo-1534579222473-b3c76b97b0a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80', location: language === 'ar' ? 'بورتسودان' : 'Port Sudan' },
  ];
